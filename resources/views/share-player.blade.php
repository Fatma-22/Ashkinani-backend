...
<head>
    ...
    <style>
        ...
        .spinner-inner {
            ...
            border-bottom-color: rgba(201,162,77,0.5);
            position: absolute;
            top: 8px;
            left: 8px;
...
<body>
    <!-- Background Image -->
    <div class="bg-image">
        <img src="https://ashkananitransfer.com/hero-bg.png" alt="">
    </div>
    ...
    <div class="content">
        ...
        <div class="brand-name">
            ASHKANANI SPORT <span>TRANSFER</span>
        </div>
    </div>
    ...
    <script>
        setTimeout(function () {
            ...
            var url = frontendDomain + "/cv/{{ $slug }}";
            if (token) {
                url += "?share_token=" + token;
            }
            window.location.href = url;
        }, 500); // 0.5 seconds to enjoy the beautiful loading screen
    </script>
</body>
</html>
