...
class UpdatePlayerRequest extends FormRequest
{
    ...
    {
        return [
            'profile_role' => ['sometimes', 'in:PLAYER,COACH,ADMINISTRATOR,REFEREE,PHOTOGRAPHER,DESIGNER'],
            ...
            'national_team_id' => ['nullable', 'exists:clubs,id'],
            ...
            'visibility_settings' => ['sometimes', 'array'],
